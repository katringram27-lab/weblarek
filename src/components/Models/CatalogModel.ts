...
export class CatalogModel { // создали класс CatalogModel
    ...
    constructor(protected events: IEvents) { // конструктор принимает объект брокера событий events
    ...
    getItemById(id: string): IProduct | undefined { // метод ищет товар в массиве items по его уникальному id
