...
export interface IApi {
  ...
  ): Promise<T>; // метод для отправки данных.Принимает адрес,тело запроса(data) и необязат параметр method(1 из 3х) и возвращает промис
}

export interface IProduct {
  // интерфейс,описывающий структуру товара в каталоге
  id: string;
  description: string;
  image: string;
  title: string;
